...
export type MealEntry = { id: string; mealType: MealType; foodNameSnapshot: string; grams: number; energyKcal: number; proteinG: number; fatG: number; carbohydrateG: number; recordedAt: string };
