...
export type MealEntry = { id: string; mealType: MealType; foodId: string | null; foodNameSnapshot: string; grams: number; energyKcal: number; proteinG: number; fatG: number; carbohydrateG: number; recordedAt: string; note?: string | null };
