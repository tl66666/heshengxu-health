...
/* Product-level control reset: keep every action centered on iOS and WeChat. */
button { display:flex; align-items:center; justify-content:center; box-sizing:border-box; line-height:1; white-space:nowrap; }
.page { background:#f4faf7; }
.nav { margin-top:0; }
.plan-card { border-radius:28rpx; background:rgba(255,254,250,.97); box-shadow:0 16rpx 40rpx rgba(83,130,117,.10); }
.status-headline { color:#4cae89; font-size:32rpx; }
.actions { gap:16rpx; }
.actions button { min-height:84rpx; padding:0 20rpx; border-radius:22rpx; font-size:24rpx; font-weight:600; }
.primary { color:#fff; background:#69c9a0; box-shadow:0 10rpx 22rpx rgba(85,184,140,.20); }
.secondary { color:#6f91ca; border:2rpx solid #b4c9ee; background:#fff; }
.checkin { min-width:158rpx; min-height:58rpx; padding:0 20rpx; display:flex; align-items:center; justify-content:center; border-radius:30rpx; font-size:20rpx; }
.reminder { min-height:54rpx; padding:0 8rpx 0 14rpx; display:flex; align-items:center; justify-content:center; }
.tips-heading button { min-height:46rpx; display:flex; align-items:center; justify-content:center; }
.record-delete { min-width:70rpx; min-height:52rpx; display:flex; align-items:center; justify-content:center; }
.settings-sheet { max-height:88vh; overflow:auto; padding-top:18rpx; border-radius:34rpx 34rpx 0 0; background:#fffdf9; }
.mode-grid { display:grid; grid-template-columns:repeat(2,minmax(0,1fr)); gap:14rpx; }
.mode-card { min-height:96rpx; padding:18rpx 18rpx; display:flex; align-items:flex-start; justify-content:center; flex-direction:column; }
.save { min-height:84rpx; display:flex; align-items:center; justify-content:center; border-radius:22rpx; font-weight:600; }
@media (max-width: 360px) { .plan-card { padding-left:22rpx; padding-right:22rpx; }.progress-ring { width:340rpx; height:340rpx; }.ring-core { width:266rpx; height:266rpx; }.ring-time { font-size:46rpx; }.window-point { min-width:112rpx; }.actions button { padding:0 12rpx; font-size:22rpx; } }
</style>
