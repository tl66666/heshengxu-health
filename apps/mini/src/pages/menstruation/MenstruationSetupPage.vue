...
<style scoped>
.page{min-height:100vh;padding:0 32rpx 56rpx;background:#f7fbf8;color:#29453a}.setup-header{padding:30rpx 4rpx 24rpx}.step-line{display:flex;align-items:center;width:132rpx;margin-bottom:26rpx}.step-dot{display:flex;align-items:center;justify-content:center;width:26rpx;height:26rpx;border:1rpx solid #d6e4da;border-radius:50%;color:#9aaba1;background:#fff;font-size:15rpx}.step-dot.active{border-color:#d889aa;color:#fff;background:#e88dae}.step-rule{width:40rpx;height:1rpx;margin:0 8rpx;background:#dce8df}.kicker{display:block;color:#ad6c8e;font-size:20rpx}.title{display:block;margin-top:8rpx;color:#2f4b3e;font-size:34rpx;font-weight:700}.subtitle{display:block;max-width:620rpx;margin-top:10rpx;color:#809289;font-size:21rpx;line-height:1.55}.paper{padding:24rpx;border:1rpx solid #dce9df;border-radius:18rpx;background:#fff;box-shadow:0 8rpx 20rpx rgba(40,87,57,.05)}.paper-art{display:flex;justify-content:center;height:116rpx;margin:-4rpx 0 8rpx}.paper-art image{width:150rpx;height:116rpx;opacity:.75}.field-row{display:grid;grid-template-columns:1fr 1fr;gap:18rpx}.field{min-width:0}.field-full{margin-top:22rpx;padding-top:20rpx;border-top:1rpx solid #edf3ee}.field-label{display:block;color:#3f574a;font-size:23rpx;font-weight:700}.optional{color:#a0ada5;font-size:19rpx;font-weight:400}.input-line,.date-line{display:flex;align-items:center;justify-content:space-between;height:70rpx;margin-top:10rpx;padding:0 14rpx;border-bottom:1rpx solid #cbded0;color:#82948a}.input-line input{width:100%;height:100%;color:#2f5140;font-size:30rpx;font-weight:700}.input-line text{font-size:20rpx}.field-help{display:block;margin-top:7rpx;color:#94a39b;font-size:18rpx}.date-line{height:64rpx;border:1rpx solid #e0ebe2;border-radius:12rpx;padding:0 14rpx;color:#486457;font-size:22rpx}.date-line .placeholder{color:#a1afa7}.chevron{color:#ad7191;font-size:28rpx}.error{display:block;margin-top:6rpx;color:#b85e43;font-size:18rpx}.quiet-note{margin-top:20rpx;padding:0 4rpx;color:#8a9a91;font-size:18rpx;line-height:1.5}.primary-button{width:100%;height:82rpx;margin-top:26rpx;border-radius:16rpx;color:#fff;background:#d984a7;font-size:27rpx;line-height:82rpx}.primary-button[disabled]{opacity:.42}
</style>
